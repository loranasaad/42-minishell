...
/*   Updated: 2025/11/04 15:06:11 by loasaad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define	CU_ALL (CU_HDOCS | CU_SPECS | CU_STAGES | CU_PIPES | CU_PIDS | CU_CLOSE_PIPES)
#define CU_BASIC (CU_HDOCS | CU_SPECS | CU_STAGES)
#define	CU_FULL_PIPES (CU_HDOCS | CU_SPECS | CU_STAGES | CU_PIPES | CU_CLOSE_PIPES)
